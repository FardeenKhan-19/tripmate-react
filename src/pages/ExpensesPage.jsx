...
export default function ExpensesPage() {
    ...
    // === FIX STARTS HERE ===
    // Budget check ke liye naya useEffect
    useEffect(() => {
        if (tripDetails && totalSpent > tripDetails.budget) {
            setOverBudgetAlert(true);
        }
    }, [totalSpent, tripDetails]);

    // handleSave function ko simplify kiya gaya
        ...
        <Box>
            ...
            <Grid container spacing={4}>
                ...
                <Grid item xs={12} md={7}><Paper sx={{ p: 3, height: '100%', borderRadius: '20px' }}>
                    ...
                    {/* === FIX: Pie chart ko currency symbol pass kiya gaya === */}
                    <ExpensesPieChart data={chartData} currencySymbol={getCurrencySymbol(tripDetails?.currency)} />
                </Paper></Grid>
            </Grid>
